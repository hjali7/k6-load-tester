...
*/}}
{{- define "web-load-tester.fullname" -}}
...
Common labels
*/}}
{{- define "web-load-tester.labels" -}}
helm.sh/chart: {{ include "web-load-tester.chart" . }}
{{ include "web-load-tester.selectorLabels" . }}
{{- if .Chart.AppVersion }}
